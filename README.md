...
- ⚡ Built a **real-time collaborative code editor using Yjs CRDT and Socket.io**
- ☁️ Deployed containerized applications using **Docker, AWS ECS, and AWS ECR**
- 🤖 Built AI-powered learning experiences using the **Gemini API**
- 🧠 Solved **600+ Data Structures & Algorithms problems**
- 🏆 **College Rank 1** — NxtWave Coding Premier League 2026
- 📈 **LeetCode 1750+** — Top ~12% Globally
- 🔵 **Codeforces Pupil** — Max Rating 1289
